...
class CivilStatusController extends BaseController {
    ...
    public function store($request) {
        $civil_status = new CivilStatusModel;
        $data = [
            'name' => $request->name,
        ...
        $log = new LogModel;
        $civil_status_id =  $civil_status->lastInsertId($data);
    ...
    public function show($request) {
        $model = new CivilStatusModel;
        $civil_status = $model->show(['id' => $request->id]);
