...
$(document).ready(function(){
    fields = [ 
        'resident_id', 'issued_at', 'or_no', 'amount', 'paid_at', 'name_of_deceased',
        'civil_status_id', 'relationship_id', 'citizenship_id', 'cause_of_death', 'death_at',
        'city_health_officer_id', 'cho_position','amount'
    ];
    let id = null;
    let module_label = 'Exhumation Certificate';
    let module = 'exhumation_certificate';
    ...
    $(document).on('click', '.btn-print', function() {
        let exhumation_id = $(this).attr('data-id');
        window.location.href = `${base_url}/views/exhumation-certificates/print.php?id=${exhumation_id}`;
    });
});