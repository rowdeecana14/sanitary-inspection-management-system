...
$(document).ready(function(){
    ...
    fields = ['name', 'edit_baranggay_id', 'status'];
    let id = null;
    let module = 'Purok';
    ...
    $(document).on('click', '.btn-delete', async function()  {
        ...
        if(confirm) {
            ...
            if(response.success) {
                deleteMessage(`${module} successfully deleted.`);
                preloadTable();
            }
            else {
                serverError();
    ...
    $(document).on('submit', '#create-form', async function(e) {
        ...
        if(response.success) {
            ...
            saveMessage(`${module} successfully saved.`);
            preloadTable();
        }
        else {
            serverError();
    ...
    $(document).on('submit', '#edit-form', async function(e) {
        ...
        if(response.success) {
            formReset($('#edit-form'));
            updateMessage(`${module} successfully updated.`);
            preloadTable();
        }
        else {
            serverError();
