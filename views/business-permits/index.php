<?php $navbar_active = "business_permits"; ?>
...
<html lang="en">
<head>
	<title>Business Permits - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-certificate"></i> Business Permits</h4>
    ...
    <script src="../../public/custom/js/business-permits.js"></script>
	<!-- End Scripts -->
</body>
</html>