...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-building"></i> Companies</h4>
    ...
    <script src="../../public/custom/js/companies.js"></script>
	<!-- End Scripts -->
</body>
</html>