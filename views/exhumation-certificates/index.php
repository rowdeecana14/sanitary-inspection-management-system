<?php $navbar_active = "exhumation_certificates"; ?>
...
<html lang="en">
<head>
	<title>Exhumation Certificates - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-certificate"></i> Exhumation Certificates</h4>
    ...
    <script src="../../public/custom/js/exhumation-certificates.js"></script>
	<!-- End Scripts -->
</body>
</html>