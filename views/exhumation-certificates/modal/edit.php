        ...
        <div class="modal-content">
            <div class="modal-header no-bd">
                <h5 class="modal-title">
                    <i class="fas fa-edit pr-1"></i> EDIT EXHUMATION CERTIFICATE
                </h5>
            ...
            <div class="modal-body">
                <form id="edit-form">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="edit_relationship_id">Relationship <span class="required-label">*</span></label>
                                <div class="select2-input">
                                    <select id="edit_relationship_id" name="relationship_id" class="form-control select2-list required" 
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control required number-decimals-only input" id="amount" name="amount">
                            </div>
                        </div>
