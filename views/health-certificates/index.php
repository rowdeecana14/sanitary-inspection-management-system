<?php $navbar_active = "health_certificates"; ?>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-certificate"></i> Health Certificates</h4>
    ...
    <script src="../../public/custom/js/health-certificates.js"></script>
	<!-- End Scripts -->
</body>
</html>