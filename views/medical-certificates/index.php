<?php $navbar_active = "medical_certificates"; ?>
...
<html lang="en">
<head>
	<title>Medical Certificates - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-certificate"></i> Medical Certificates</h4>
    ...
    <script src="../../public/custom/js/medical-certificates.js"></script>
	<!-- End Scripts -->
</body>
</html>