        ...
        <div class="modal-content">
            <div class="modal-header no-bd">
                <h5 class="modal-title">
                    <i class="fas fa-edit pr-1"></i> EDIT MEDICAL CERTIFICATE
                </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required blood-pressure-only input" id="blood_pressure" name="blood_pressure">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required input" id="fit_for" name="fit_for">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker required input" id="paid_at" name="paid_at">
                            </div>
                        </div>

                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="edit_city_health_officer_id">Medical Officer<span class="required-label">*</span></label>
                                <div class="select2-input">
