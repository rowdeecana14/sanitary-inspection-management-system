            ...
            <div class="modal-body">
                ...
                <div style="margin-top: 15px">
                    <div class="d-flex justify-content-center">
                        ...
                        <div>
                            <button class="btn btn-primary btn-sm  btn-border btn-round ml-1 btn-camera-capture" style="font-weight:900; font-size: 12px !important;"><i class="fas fa-camera-retro"></i> Capture</button>
                        </div>
                    </div>
                </div>
            </div>
