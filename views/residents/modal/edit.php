            ...
            <div class="modal-body">
                <div class="col-md-12 col-lg-12">
                    <ul class="nav nav-pills nav-secondary nav-pills-no-bd tablist" id="pills-tab-without-border" role="tablist">
                        ...
                        <li class="nav-item tab-link" >
                            <a class="nav-link contact_address" data-tab="contact_address" id="pills-contact-address-2-tab-nobd" data-toggle="pill" href="#pills-contact-address-2-nobd" role="tab" aria-controls="pills-contact-address-2-nobd" aria-selected="false"><i class="fa fa-map-signs pr-1"></i> Contact & Address</a>
                        </li>
                        <li class="nav-item tab-link">
                    ...
                    <div class="tab-content mt-2 mb-3" id="pills-without-border-tabContent">
                        <div class="tab-pane fade show active basic_info-tab-content default-tab-content" id="pills-basic-info-2-nobd" role="tabpanel" aria-labelledby="pills-basic-info-2-tab-nobd">
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group"  style="margin-top: 3rem;">
                                                    ...
                                                    <input type="text" class="form-control required input" id="national_id" name="national_id"  >
                                                </div>

                                                <div class="form-group">
                                                    <label for="edit_voter_status">Voter Status <span class="-label">*</span></label>
                                                    <div class="select2-input">
                                                        <select id="edit_voter_status" name="voter_status" class="form-control select-group required">
                                                ...
                                                <div class="form-group">
                                                    <label for="edit_person_disability_id">Person with Disability <span class="-label">*</span></label>
                                                    <div class="select2-input">
                                                ...
                                                <div class="form-group" >
                                                    <label for="edit_position_id">Position <span class="-label">*</span></label>
                                                    <div class="select2-input">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="edit_citizenship_id">Citizenship <span class="-label">*</span></label>
                                                    <div class="select2-input">
                        ...
                        <div class="tab-pane fade contact_address-tab-content" id="pills-contact-address-2-nobd" role="tabpanel" aria-labelledby="pills-contact-address-2-tab-nobd">
                            <div class="card">
                                <div class="card-body">
                                    <form id="contact_address_form_edit">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                        ...
                        <div class="tab-pane fade other_info-tab-content" id="pills--other-info-2-nobd" role="tabpanel" aria-labelledby="pills--other-info-2-tab-nobd">
                            <div class="card">
                                <div class="card-body">
                                    <form id="other_info_form_edit">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="edit_blood_type">Blood Type <span class="-label">*</span></label>
                                                    <div class="select2-input">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control input numbers-only" id="total_household_member" name="total_household_member"  >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input number-decimals-only" id="monthly_income" name="monthly_income"  >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="skills" name="skills"  class="form-control tags-input input" data-role="tagsinput">
                                                </div>
                                            </div>
                                         
                                            <div class="col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="edit_land_ownerships">Land Ownerships </label>
                                                    <input type="text" id="edit_land_ownerships" name="land_ownerships"  class="form-control tags-input input" data-role="tagsinput">
                                                </div>
                                            </div>

                                            <div class="col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="edit_house_ownerships">House Ownerships</label>
                                                    <input type="text" id="edit_house_ownerships" name="house_ownerships"  class="form-control tags-input input" data-role="tagsinput">
                                                </div>
                                            </div>

                                            <div class="col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="edit_water_usages">Water Usages </label>
                                                    <input type="text" id="edit_water_usages" name="water_usages"  class="form-control tags-input input" data-role="tagsinput">
                                                </div>
                                            </div>

                                            <div class="col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label for="edit_lighting_facilities">Lighting Facilities </label>
                                                    <input type="text" id="edit_lighting_facilities" name="lighting_facilities"  class="form-control tags-input input" data-role="tagsinput">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
