<?php $navbar_active = "sanitary_permits"; ?>
...
<html lang="en">
<head>
	<title>Sanitary Permits - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-certificate"></i> Sanitary Permits</h4>
    ...
    <script src="../../public/custom/js/sanitary-permits.js"></script>
	<!-- End Scripts -->
</body>
</html>