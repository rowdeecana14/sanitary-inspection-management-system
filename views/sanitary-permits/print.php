...
<meta content="<?= $_GET['id'] ?>" name="sanitary_permit_id" />
<title>Print Sanitary Permit - SIMS</title>
...
<body>
	<button class="btn-circle-back" onclick="window.location.href='<?= base_url(); ?>/views/sanitary-permits/'" >
	...
	<div class="width">
		...
		<div class="business-permit">SANITARY PERMIT</div>
    ...
    <script src="../../public/custom/js/sanitary-permit-print.js"></script>
</body>
</html>
