<?php $navbar_active = "setting_blood_types"; ?>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-syringe"></i> Blood Types</h4>
    ...
    <script src="../../public/custom/js/settings/blood-types.js"></script>
