<?php $navbar_active = "setting_checklists"; ?>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-list-ul"></i> Checklist</h4>
    ...
    <script src="../../public/custom/js/settings/checklists.js"></script>
	<!-- End Scripts -->
</body>
</html>