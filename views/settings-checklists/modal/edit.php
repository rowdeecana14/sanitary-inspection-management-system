                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input" id="description" name="description" placeholder="" required>
                            </div>

                            <!-- <div class="form-group">
                                <label for="passing_rate">Passing Rate <span class="required-label">*</span></label>
                                <input type="number" class="form-control input" id="passing_rate " min="0" max="100" name="passing_rate" placeholder="" required>
                            </div> -->
