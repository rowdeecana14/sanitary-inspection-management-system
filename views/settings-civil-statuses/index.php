<?php $navbar_active = "setting_civil_statuses"; ?>
...
<html lang="en">
<head>
	<title>Civil Statuses - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-balance-scale"></i> Civil Statuses</h4>
	...
	<script src="../../public/custom/js/settings/civil-statuses.js"></script>
	<!-- End Scripts -->
</body>
</html>