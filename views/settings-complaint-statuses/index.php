<?php $navbar_active = "setting_complaint_statuses"; ?>
...
<html lang="en">
<head>
	<title>Complaint Statuses - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-user-tag"></i> Complaint Statuses</h4>
	...
	<script src="../../public/custom/js/settings/complaint-statuses.js"></script>
	<!-- End Scripts -->
</body>
</html>