<?php $navbar_active = "setting_complaint_types"; ?>
...
<html lang="en">
<head>
	<title>Complaint Types - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-gavel"></i> Complaint Types</h4>
	...
	<script src="../../public/custom/js/settings/complaint-types.js"></script>
	<!-- End Scripts -->
</body>
</html>