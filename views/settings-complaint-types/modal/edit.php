    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group">
                                <label for="edit_name">Type <span class="required-label">*</span></label>
                                <input type="text" class="form-control input" id="edit_name" name="name" placeholder="" required>
                            </div>
            ...
            <div class="modal-footer no-bd">
                ...
                <button type="submit" form="edit-form" class="btn btn-primary"><i class="fas fa-check-circle"></i> Save</button>
            </div>
        </div>
    </div>
</div>