<?php $navbar_active = "setting_educational_attainments"; ?>
...
<html lang="en">
<head>
	<title>Educational Attainments - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-user-graduate"></i> Educational Attainments</h4>
    ...
    <script src="../../public/custom/js/settings/educational-attainments.js"></script>
