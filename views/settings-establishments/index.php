<?php $navbar_active = "setting_establishments"; ?>
...
<html lang="en">
<head>
	<title>Establishments - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-building"></i> Establishments</h4>
    ...
    <script src="../../public/custom/js/settings/establishments.js"></script>
	<!-- End Scripts -->
</body>
</html>