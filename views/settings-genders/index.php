<?php $navbar_active = "setting_genders"; ?>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-venus-mars"></i> Genders</h4>
    ...
    <script src="../../public/custom/js/settings/genders.js"></script>
	<!-- End Scripts -->
</body>
</html>