<?php $navbar_active = "setting_occupations"; ?>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-briefcase"></i> Occupations</h4>
    ...
    <script src="../../public/custom/js/settings/occupations.js"></script>
