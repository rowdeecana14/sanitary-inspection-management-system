<?php $navbar_active = "setting_person_disabilities"; ?>
...
<html lang="en">
<head>
	<title>Person Disabilities - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-wheelchair"></i> Person Disabilities</h4>
    ...
    <script src="../../public/custom/js/settings/person-disabilities.js"></script>
	<!-- End Scripts -->
</body>
</html>