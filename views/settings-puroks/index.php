<?php $navbar_active = "setting_puroks"; ?>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fas fa-map-marked"></i> Puroks</h4>
	...
	<script src="../../public/custom/js/settings/puroks.js"></script>
	<!-- End Scripts -->
</body>
</html>