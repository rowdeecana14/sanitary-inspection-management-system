<?php $navbar_active = "setting_relationships"; ?>
...
<html lang="en">
<head>
	<title>Relationships - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-sitemap"></i> Relationship</h4>
	...
	<script src="../../public/custom/js/settings/relationship.js"></script>
	<!-- End Scripts -->
</body>
</html>