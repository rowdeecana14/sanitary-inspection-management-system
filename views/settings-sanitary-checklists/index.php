<?php $navbar_active = "setting_sanitary_checklists"; ?>
...
<html lang="en">
<head>
	<title>Sanitary Checklists - SIMS</title>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-list-ul"></i> Sanitary Checklists</h4>
									</div>
								</div>
								<div class="card-body">
                                    <!-- Edit Modal -->
    ...
    <script src="../../public/custom/js/settings/sanitary-checklists.js"></script>
	<!-- End Scripts -->
</body>
</html>