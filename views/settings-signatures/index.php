<?php $navbar_active = "setting_signatures"; ?>
...
<body>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><i class="fas fa-file-signature"></i> Signatures</h4>
									</div>
								</div>
								<div class="card-body">
                                    <!-- Edit Modal -->
    ...
    <script src="../../public/custom/js/settings/signatures.js"></script>
	<!-- End Scripts -->
</body>
</html>