        ...
        <div class="modal-content">
            <div class="modal-header no-bd">
                <h5 class="modal-title">
                    <i class="fas fa-edit pr-1"></i> ADD TRANSFER OF CADAVER
                </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" id="place_of_death" name="place_of_death">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="select2-input">
                                    <select data-type="create" id="city_health_officer_id" name="city_health_officer_id" class="form-control select2-list required city_health_officer_id" 
                                        data-module="health_official" data-action="select2">
                                        <option value="" disabled selected>Select Name</option>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="create_cho_position">Position <span class="required-label">*</span></label>
                                <input type="text" class="form-control required input" id="create_cho_position" name="cho_position" >
                            </div>
                        </div>
